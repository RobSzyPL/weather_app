...
let apiUrl = 'http://api.weatherapi.com/v1/current.json?key=fbbdaa91916f423490d131233230104&aqi=yes&q='
...
weatherForm.addEventListener('submit', (event) => {
    ...
    fetch(fullApiUrl).then(response => response.json()).then((dataFromApi) => {
        ...
        //temp
        view += `<div class="weather__temp"> ${dataFromApi.current.temp_c} <span> &deg; C</span>`
